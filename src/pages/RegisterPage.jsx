      ...
      <div
        ...
        <form onSubmit={handleRegister}>
          <div className='flex flex-col bg-none shadow-lg 
            ...
            <div className='flex flex-col justify-center items-center space-y-2 md:space-y-3 xl:space-y-4 w-full whitespace-nowrap '>
              ...
              <div className='flex flex-col w-full max-w-md space-y-1 lg:space-y-2'>
                ...
                <div className='flex flex-row justify-between'>
                  <Input
                    ...
                    required
                  />
                  <button type='button' className=' inset-y-0 right-0 flex items-center cursor-pointer' onClick={(e) => {
                    e.preventDefault()
