        ...
        <div className='m-5 flex flex-col space-y-5 lg:space-y-8 md:ml-[5%] lg:mt-9'>
          <div className='flex flex-col text-[var(--color-white)] space-y-4 lg:space-y-8'>
            <h1 data-aos="fade-right" data-aos-delay="200" data-aos-duration="1500" data-aos-easing="ease-in-out"
              className='font-title text-5xl md:text-6xl lg:text-8xl max-w-[85%] text-[var(--color-white)]'>
            ...
            <div className='max-w-[75%] space-y-1 ml-[1%]'>
              <p data-aos="fade-right" data-aos-delay="300" data-aos-duration="1500" data-aos-easing="ease-in-out"
                className='font-text text-md md:text-lg lg:text-3xl text-[var(--color-green)]'>
