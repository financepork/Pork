...
const LandingPage = () => {
  ...
  return (
    <div>
      ...
      <section className='bg-[var(--color-white)] flex justify-center'>
      ...
      <section className='bg-[var(--color-green)] max-h-auto'>
        <div className='flex flex-col md:flex-row justify-center items-center space-y-8 h-auto'>
