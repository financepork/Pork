  ...
  return (
    <div>
      <section className='h-auto bg-[url("/background.png")] bg-cover bg-center'>
        <Navbar />
        <div className='m-5 flex flex-col space-y-5 md:ml-[5%]'>
          <div className='flex flex-col text-[var(--color-white)] space-y-4'>
            <h1 data-aos="fade-right" data-aos-delay="200" data-aos-duration="1500" data-aos-easing="ease-in-out"
              className='font-title text-5xl md:text-6xl max-w-[85%] text-[var(--color-white)]'>
            ...
            <div className='max-w-[75%] space-y-1 ml-[1%]'>
              <p data-aos="fade-right" data-aos-delay="300" data-aos-duration="1500" data-aos-easing="ease-in-out"
                className='font-text text-md md:text-lg text-[var(--color-green)]'>
          ...
          <div data-aos="fade-right" data-aos-delay="400" data-aos-duration="1500" data-aos-easing="ease-in-out"
            className='flex space-x-3 font-text md:ml-[1%]'>
            <a href="#" className='bg-[var(--color-green)] p-2 font-text hover:text-[var(--color-green)] hover:bg-[var(--color-white)] shadow-md 
          rounded-2xl transition-colors duration-400 ease-in-out w-[26%] flex justify-center items-center'><button>Comece Já</button></a>
      ...
      <section className='bg-[var(--color-green)] h-auto flex justify-center items-center'>
        <div className='flex sm:items-center md:justify-center flex-col h-auto'>
      ...
      <section className='bg-[var(--color-white)] h-auto'>
        <div className='flex justify-center flex-col items-center space-y-8 md:space-y-15  p-6'>
          <div>
            <h1 className='text-[var(--color-black)] font-title-alt text-3xl md:text-5xl'>Principais Benefícios</h1>
          </div>
          <div data-aos="fade-right" data-aos-delay="300" data-aos-duration="1500" data-aos-easing="ease-in-out"
            className='flex flex-col space-y-8 w-[60%] h-auto md:m-4'>
      ...
      <section className='bg-[var(--color-green)] max-h-auto md:h-auto'>
        <div className='flex flex-col justify-center items-center space-y-8 h-auto'>
          <div className='flex flex-col justify-center items-center w-[80%] mt-8 space-y-3'>
            <h1 className='font-title-alt text-[var(--color-white)] text-3xl md:text-6xl'>Gosta de Economizar?</h1>
            <p className='font-text-alt  text-[var(--color-white)] ml-3 text-lg md:text-2xl'>Aproveite agora o seu mais novo Porquinho Digital!</p>
          ...
          <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-easing="ease-in-out" className='flex justify-center items-center'>
            <img src="./fotoCofrinho.png" alt="" className='w-[70%] md:w-[50%] rounded-3xl' />
          </div>
      ...
      <section className='bg-[var(--color-black)] max-h-auto'>
        <div className='flex flex-col'>
          <div className='mt-5 ml-5 flex md:justify-center items-center'>
            <h1 className='text-[var(--color-white)] font-title-alt text-3xl md:text-5xl'>Conheça os <span className='text-[var(--color-green)]'>Desenvolvedores</span> <span className='text-[var(--color-green)]'>:</span></h1>
          </div>
