  ...
  return (
    <header className='relative'>
      <nav className='flex justify-between bg-[var(--color-black)] text-[var(--color-white)] w-full h-auto p-3 md:p-4 lg:p-5 xl:p-6 border-nav xl:space-x-8 lg:px-12 xl:px-24  '>
        <a href='/LandingPage' className='flex justify-center items-center text-2xl md:text-3xl xl:text-4xl 2xl:text-5xl font-title space-x-1'>
      ...
      {isOpen && (
        <nav>
          <div className='absolute md:hidden w-full bg-[var(--color-black)] text-white font-title-alt flex flex-row justify-center items-center space-x-2  py-4 shadow-md z-50'>
            ...
            <a href="/RegistrarConta" className="border-0 text-[var(--color-black)] bg-[var(--color-white)] rounded-2xl p-3 hover:bg-[var(--color-green)] hover:text-[var(--color-white)] transition-colors duration-400 ease-in-out w-[30%] text-center"><button>Registre-se</button></a>
          </div>
        </nav>
