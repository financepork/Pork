...
const SmallCard = ({imgPath, text}) => {
  return (
    <div className='flex flex-col justify-center items-center border-2 space-y-2 md:space-y-6 rounded-2xl p-8 border-[var(--color-green)] md:h-[10%] md:w-[100%] lg:h-80'>
