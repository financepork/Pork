...
const CardWindow = ({titleText, imgSrc, windowOpen, setOpenWindow}) => {
  return (
    <button className='flex flex-col h-[30%] md:min-h-[90%]  w-[47%] max-w-100 md:max-w-80 xl:max-w-100 bg-[var(--color-green)] text-[var(--color-white)]  rounded-2xl justify-between  items-center p-4 shadow-md hover:scale-105 transition-all duration-500 ease-in space-y-2 md:space-y-4 cursor-pointer hover:bg-[var(--color-white)] hover:text-[var(--color-green)]
    '
