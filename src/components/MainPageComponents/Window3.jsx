  ...
  return (
    <div
      ...
      <div 
        ...
        <h1 className='font-title-alt text-4xl text-[var(--color-white)] md:text-5xl xl:text-6xl text-center'>a</h1>
        <p className='font-text-alt text-xl md:text-2xl xl:text-3xl text-[var(--color-white)] text-center'>b</p>
      </div>
      <div 
