       ...
       className='flex flex-col xl:flex-row h-[100%] w-full bg-[var(--color-black)] rounded-t-2xl xl:rounded-t-4xl p-16 overflow-y-none items-center justify-around'>
        <div className='m-8'>
          <form action="submit"  className='flex flex-col space-y-6 md:space-y-8 p-2'>
            ...
            <input type="text" maxLength={40} name="descMeta" id="descMeta" placeholder='Coloque sua meta' className='bg-[var(--color-green)] text-[var(--color-white)] font-title-alt rounded-2xl text-lg md:text-xl xl:text-2xl  p-2 md:p-4' />
