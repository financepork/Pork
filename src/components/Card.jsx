...
const Card = ({ title, text, imgPath }) => {
    return (
        <div className='bg-[var(--color-black)] m-10 w-310 h-120 rounded-3xl flex justify-between p-8 shadow-[1px_1px_25px_1px_var(--color-dark-green)]'>
            <div>
                <h2 className='text-[var(--color-white)] font-title leading-tight pb-3 text-7xl ml-6'>{title}</h2>
