...
const CardApresentacaoEsq = ({ DevName, DevStack, DevImgSrc, devInsta, devGithub, devLinkedin }) => {
    return (
        <div 
            ...
            className='bg-[var(--color-white)] rounded-tr-full rounded-br-full flex p-3 mt-9 mr-9 xl:mr-18 h-auto xl:h-[400px]'
        >
            <div className='flex flex-row items-center w-full'>
                ...
                <div className='flex flex-col justify-center mr-5 space-y-2 md:space-y-4 flex-1'>
                    ...
                    <div className='flex justify-center space-x-2'>
                        <a href={devInsta}><img src="./instagram.png" alt="Logo Instagram" className='h-6 md:h-8 xl:h-10' /></a>
                        <a href={devGithub}><img src="./github.png" alt="Logo Github" className='h-6 md:h-8 xl:h-10' /></a>
                        <a href={devLinkedin}><img src="./linkedin.png" alt="Logo Linkedin" className='h-6 md:h-8 xl:h-10' /></a>
                    </div>
                </div>
