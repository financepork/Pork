...
export default function CTASectionBottom() {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden" style={{ backgroundColor: '#22c55e' }}>
      ...
      <div className="flex-1 flex flex-col justify-center px-8 lg:px-10 py-4">
        <h2
          ...
          style={{ fontSize: 'clamp(5rem, 13vw, 14rem)', fontWeight: 800, color: '#0a0a0a' }}
        >
          Seu dinheiro
        </h2>
        <h2
      ...
      <div
        ...
        style={{ borderColor: 'rgba(0,0,0,0.15)', background: 'rgba(0,0,0,0.06)' }}
      >
        ...
        <Link
          to="/register"
          className="group inline-flex items-center gap-3 font-bold px-10 py-5 rounded-2xl text-base transition-all duration-200 active:scale-95 whitespace-nowrap flex-shrink-0"
          style={{
            background: '#0a0a0a',
            color: '#22c55e',
