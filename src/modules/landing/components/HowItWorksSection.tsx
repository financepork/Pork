  ...
  return (
    <section id="how-it-works" className="py-28 overflow-hidden">
      <div className="mx-auto max-w-6xl px-6">
        ...
        {/* Heading */}
        <div className="mb-24">
          <p className="text-xs font-semibold text-brand mb-5 uppercase tracking-[0.2em]">
            Como funciona
          </p>
          <h2
        ...
        {/* Step 01 */}
        <div className="relative grid lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div className="bg-neutral-900 border border-neutral-800/60 rounded-2xl p-6 w-full max-w-sm">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-600">Bem-vindo ao Pork</p>
                </div>
              </div>
        ...
        <div className="relative grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="relative z-10 flex justify-center lg:justify-start order-2 lg:order-1">
            <div className="bg-neutral-900 border border-neutral-800/60 rounded-2xl p-6 w-full max-w-sm">
              <p className="text-[11px] font-semibold text-neutral-600 uppercase tracking-widest mb-4">Gastos de março</p>
              {[
          ...
          <div className="relative z-10 flex flex-col gap-5 order-1 lg:order-2">
          ...
          <div className="relative z-10 flex justify-center lg:justify-end">
            <div className="bg-neutral-900 border border-neutral-800/60 rounded-2xl p-6 w-full max-w-sm">
              <div className="flex items-start justify-between mb-5">
                <div>
                  <p className="text-[11px] text-neutral-600 uppercase tracking-widest font-semibold">Economias</p>
